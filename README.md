...
My python learning journey- building practical projects- working through "Automate the boring stuff " by AI Sweigart

# About
This repository contains all ,y practice projects and exercises as i learn python programming and automation.Each chapter folder contains the projects and concets i've implemented.

# Progress tracker
## Completed Chapters
-[Chapter 1:Python Basics](./chapter-01-python-basics)
-[Chapter 2:Flow Control](./chapter-02-flow-control)
-[Chapter 3:Loops](./chapter-03-loops) 
-[Chapter 4:Functions](./chapter-04-functions)

## Currently Working On
-[Chapter 5:Debugging](./chapter-05-debugging)
